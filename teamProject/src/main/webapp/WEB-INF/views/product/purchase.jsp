	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="mb-4">
				...
				<div style="margin-left: 10px;" class="small text-muted">VAT
					별도</div>
					...
					<thead>
						<tr>
							...
							<th scope="row" colspan="1" width="20%"
								style="text-align: center">상품정보</th>
							<th scope="row" colspan="1" width="20%"
					...
					<tbody class="table-group-divider">
						<tr>
							<td style="vertical-align: middle"><input type="checkbox"
								name="chk" value="productVo"
								data-product_id="${productVo.product_id}" checked></td>
							...
							<td
								style="vertical-align: middle; text-align: center; font-size: 15px; color: #CF492C;">${param.totalPrice}
								Point</td>
						</tr>
					</tbody>
				</table>
				<div style="height: 20px;"></div>
				<a style="float: right; margin-right: 10px;" id="selectpurchase_btn"
